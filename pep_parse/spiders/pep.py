...
class PepSpider(scrapy.Spider):
    ...
    def parse(self, response):
        """
        Метод для обработки начальной страницы, извлечения ссылок на PEP и перехода к каждой ссылке.
    ...
    def parse_pep(self, response):
        """
        Метод для обработки страницы PEP и извлечения информации о номере, имени и статусе PEP.
